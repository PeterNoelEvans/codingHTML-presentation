...
# Create the turtle for drawing the flag and stick
peta = turtle.Turtle()
peta.shape('turtle')
peta.shapesize(2)
peta.pensize(3)
...
# Function to draw the flag stick
def draw_flag_stick():
    peta.penup()
    peta.goto(-350, -300)  # Position the stick to the left of the red flag
    peta.pendown()
    peta.color('saddlebrown')  # Set stick color to brown
    peta.begin_fill()
    peta.left(90)
    peta.forward(step * 6)  # Height of the stick
    peta.right(90)
    peta.forward(20)  # Thickness of the stick
    peta.right(90)
    peta.forward(step * 6)
    peta.right(90)
    peta.forward(20)
